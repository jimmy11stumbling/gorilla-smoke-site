...
// A very simplified admin interface that doesn't use hooks
export default function AdminTest() {
  // Simple demo data for display
  const demoStats = {
    leads: 285,
    contacts: 178,
    menuItems: 45,
  ...
  const switchTab = (tabId: string) => {
    ...
    for (let i = 0; i < contentSections.length; i++) {
      (contentSections[i] as HTMLElement).style.display = 'none';
    }
    ...
    for (let i = 0; i < tabs.length; i++) {
      ...
      tabs[i].classList.add('bg-gray-100', 'hover:bg-gray-200');
    }
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Login Section */}
      <div id="admin-login" className="container mx-auto py-12 px-4">
      ...
      <div id="admin-dashboard" className="container mx-auto py-6 px-4" style={{ display: 'none' }}>
        <div className="flex flex-col md:flex-row">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 mb-4">
              ...
              <nav className="mt-4">
                <button
                  ...
                  className="nav-tab w-full text-left mb-2 px-4 py-2 rounded-md bg-primary text-white font-medium flex items-center"
                  onClick={() => switchTab('dashboard-content')}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button
                  id="tab-menu-content" 
                  className="nav-tab w-full text-left mb-2 px-4 py-2 rounded-md bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium flex items-center"
                  onClick={() => switchTab('menu-content')}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button
                  id="tab-leads-content"
                  className="nav-tab w-full text-left mb-2 px-4 py-2 rounded-md bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium flex items-center"
                  onClick={() => switchTab('leads-content')}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button
                  id="tab-contacts-content"
                  className="nav-tab w-full text-left mb-2 px-4 py-2 rounded-md bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium flex items-center"
                  onClick={() => switchTab('contacts-content')}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button
                  id="tab-users-content"
                  className="nav-tab w-full text-left mb-2 px-4 py-2 rounded-md bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium flex items-center"
                  onClick={() => switchTab('users-content')}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex-1 md:ml-6">
            {/* Dashboard Content */}
            <div id="dashboard-content" className="content-section bg-white rounded-lg shadow-md p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  ...
                  <p className="text-2xl font-bold text-gray-800">{demoStats.leads}</p>
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  ...
                  <p className="text-2xl font-bold text-gray-800">{demoStats.contacts}</p>
                  <p className="text-xs text-green-500 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                    </svg>
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  ...
                  <p className="text-2xl font-bold text-gray-800">{demoStats.popularService}</p>
            ...
            {/* Menu Content */}
            <div id="menu-content" className="content-section bg-white rounded-lg shadow-md p-6" style={{ display: 'none' }}>
            ...
            {/* Leads Content */}
            <div id="leads-content" className="content-section bg-white rounded-lg shadow-md p-6" style={{ display: 'none' }}>
            ...
            {/* Contacts Content */}
            <div id="contacts-content" className="content-section bg-white rounded-lg shadow-md p-6" style={{ display: 'none' }}>
            ...
            {/* Users Content */}
            <div id="users-content" className="content-section bg-white rounded-lg shadow-md p-6" style={{ display: 'none' }}>
